...
export const coaches = [
    {
        ...
        bio: "International Certified Fitness Coach with over 15 years of extensive experience in the fitness industry. Pankaj holds a Diploma in Personal Training along with certifications in Sports Nutrition, Kids Fitness Training, CPR & AED. He is also a registered Exercise Professional in India, bringing both expertise and credibility to every session he conducts. He specializes in Weight Loss, Muscle Gain, and Complete Body Transformation, with strong expertise in Strength Training, Functional Training, CrossFit, Kettlebell Training, Resistance Band Exercises, Cardio Training, and Nutrition Guidance. What sets Pankaj apart is his scientific and personalized approach. He designs customized programs that strategically combine effective training methods with structured nutrition plans to ensure sustainable, long-term results. With a powerful blend of experience, knowledge, and motivation, Pankaj is dedicated to helping every member transform their body, enhance performance, and achieve a healthier lifestyle. Ready to transform your body and improve your health? Train with the best at Studio FIT India."
    },
    {
        id: 2,
        name: "Puja Vaish",
        ...
        bio: "Meet Our Aerobics & Pilates Expert – Puja Vaish. At Studio FIT India, we are proud to introduce Puja Vaish, a passionate and certified Aerobics and Pilates Trainer with 9 years of experience in the fitness industry. Over the years, Puja has successfully guided clients of all fitness levels toward better cardiovascular health, stronger core muscles, improved flexibility, and enhanced overall well-being. She specializes in conducting high-energy aerobic sessions that are dynamic, engaging, and results-driven, along with mindful Pilates workouts that emphasize proper alignment, body awareness, and functional strength. Puja's training style is supportive, motivating, and completely goal-focused. She carefully tailors each session to match individual fitness levels, ensuring workouts are safe, effective, and enjoyable. At Studio FIT India, she is committed to empowering every member to feel stronger, healthier, and more confident — one session at a time."
    },
    {
        id: 3,
        name: "Nitin Dabhade",
    ...
    },
    {
        ...
        image: "https://res.cloudinary.com/dvrwadsfh/image/upload/v1782550339/20745e25-df7a-45f0-b33b-31e40dd86dbd.png",
        bio: "Hello, my name is Jyoti Yadav. I am a certified international yoga trainer and also hold a diploma in yoga sciences. I have done my diploma in yoga sciences from Morarji Desai National Institute of Yoga and 200hrs TT course from Patanjali International Yoga Foundation, Rishikesh. I have working experience with five-star hotel The Imperial, Delhi as a yoga trainer, also worked with schools and worked in a campsite in Shivpuri, Rishikesh with a total experience of 6yrs. My expertise lies in physical alignment of the body through yoga asana, and how to calm the body during anxiety and stress through dwelling into one's space in Meditation. I have deep knowledge of Shatkarma, Mudras, Bandha, Pranayama and different forms of meditation. I teach forms of yoga - Hatha Yoga, Ashtanga Yoga, Iyengar Yoga along with Wheel Yoga, Chair Yoga, Face Yoga and Wall Yoga to develop strength and flexibility. Let’s transform our life through yogic style, are you ready for it?"
    ...
    },
    {
        ...
        image: "https://res.cloudinary.com/dvrwadsfh/image/upload/v1782129840/WhatsApp_Image_2026-06-22_at_5.23.43_PM_k9ifdt.jpg",
    ...
    },
    {
        ...
        image: "https://res.cloudinary.com/dvrwadsfh/image/upload/v1782549901/Screenshot_2026-03-28-19-22-50-96_92460851df6f172a4592fca41cc2d2e6.jpg_3_g1gzso.jpg",
