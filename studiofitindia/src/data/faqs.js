export const faqs = [
    ...
    { q: "What are your batch timings?", a: "We offer flexible batch timings for both morning and evening sessions. Please contact us on WhatsApp for the latest schedule." },
    { q: "Do you offer group classes?", a: "Yes, group classes are one of our highlights. They are energetic, motivating, and budget-friendly while still being trainer-guided." },
    { q: "Is yoga suitable for beginners?", a: "Yes, our yoga sessions are beginner-friendly and can be modified based on flexibility and comfort levels." },
    { q: "What if I have an injury or medical condition?", a: "Please inform us before joining. Our trainers will modify exercises accordingly. In some cases, medical clearance may be required." },
    { q: "Do you offer trial classes?", a: "Yes, we offer trial sessions for all our programs. You can book a trial at just ₹1 to experience our live coaching." },
    { q: "How can I join Studio Fit India?", a: "You can DM \"FIT\" on Instagram or WhatsApp us directly to book a trial at just ₹1 and get enrollment details." },
    { q: "Where is Studio Fit India located?", a: "Please visit our Contact page or Google Maps listing for the exact location and directions." },
    { q: "What makes Studio Fit India different?", a: "We focus on personal attention, correct technique, positive environment, and long-term fitness — not just short-term results." }
];
