  ...
  return (
    <div className="fixed bottom-24 right-5 z-40 flex flex-col items-end gap-3">
      ...
      <a
        ...
        aria-label="Chat on WhatsApp — ₹1 trial class"
        className="group relative bg-[#25D366] text-white p-4 rounded-full flex items-center justify-center hover:bg-[#20bd5a] transition-all duration-300 hover:scale-110 shadow-lg shadow-[#25D366]/40"
        onClick={() => {
          if (typeof window !== "undefined" && window.gtag) {
            window.gtag("event", "whatsapp_click", {
              event_category: "engagement",
              event_label: "whatsapp_sticky_button",
            });
          }
        }}
      >
        ...
        <WhatsAppIcon />
        <span className="sr-only">Chat with us on WhatsApp about the ₹1 trial class</span>
      </a>
    </div>
  );
};
